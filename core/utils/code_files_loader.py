...
def read_files_from_directory(directory: str):
    """
    Read the contents of all .py files in the specified directory. The author and timestamp fields are left empty.
...
def read_files_from_dict_list(dict_list: list):
    """
    Read the contents of all .py files in the directories found inside the git contribution dictionaries.
